...
\hspace{0.4cm}only astronomy-specific PhD scholarship of the University of Cambridge.\\
...
\textbf{Total number of citations:} 665 (using ADS and InSpire).
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{22} talks at conferences}, {\textbf{20} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{29} invited presentations).}
\end{tabular}
}
...
\newline{} 
Physics Colloquium, Montana State University, Bozeman MT, USA, Feb 2018.
\vspace{0.05cm}\\
