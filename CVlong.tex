...
\\
& &{(out of which \textbf{15} first-authored papers and \textbf{3} papers covered by press releases).}
\end{tabular}
}
\textbf{Total number of citations:} 629 (using ADS and InSpire).
...
%
\textbf{2.} & & \textit{Explaining LIGO's observations via isolated binary evolution with natal kicks.} 
\newline{}
...
\suppress \cite{2017arXiv170704637V} \endsuppress % UPDATE
\vspace{0.09cm}\\
%
