...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{18} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
...
\textbf{Total number of citations:} 467 (using ADS and InSpire).
...
\newline{}
U. Sperhake, C. J. Moore, R. Rosca, M. Agathos,  \textbf{D.~Gerosa} and C. D. Ott.
 \newline{}
