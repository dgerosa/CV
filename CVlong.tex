...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{23} talks at conferences}, {\textbf{23} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{32} invited presentations).}
\end{tabular}
}
