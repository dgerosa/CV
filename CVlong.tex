...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{23} papers published in major peer-reviewed journals}, {\textbf{6} papers in submission stage,}
\\
...
\textbf{Total number of citations:}  {>850}  (using ADS and InSpire).
...
%
\textbf{6.} & & \textit{Frequency-domain waveform approximants capturing Doppler shifts.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Optimizing LIGO with LISA forewarnings to improve black-hole spectroscopy.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Mining gravitational-wave catalogs to understand binary stellar evolution: a new hierarchical bayesian framework.} 
\newline{}
