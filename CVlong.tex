...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{25} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
& &{\textbf{4} other papers published in conference proceedings, software journals, etc,}
\\
& &{(out of which \textbf{17} first-authored papers and \textbf{3} papers covered by press releases).}
\end{tabular}
}
\textbf{Total number of citations:}  {>900}  (using ADS and InSpire).
...
%\vspace{-0.0cm}
%\hspace{0.71cm}Summer project (LIGO SURF program). Main supervisor. ADD_PAPER_HERE
%\vspace{-0.0cm}
%
%\vspace{0.1cm}
...
\end{tabular}
\vspace{+0.15cm}
% Also Universe, Galaxies
 
 \textbf{\textcolor{black}{Grant proposal reviewer and panelist}}\vspace{0.1cm}\\
\begin{tabular}{@{\hskip 0.4cm}l}
$\circ\;$ NASA Astrophysics Theory Program (ATP) \\
$\circ\;$ NASA Graduate Fellowship Program (NESSF)
\end{tabular}
\vspace{+0.15cm}
...
\\ &\hspace{0.4cm} &  \hspace{0.4cm}Toolbox to study the post-Newtonian dynamics of  spinning black-hole binaries; used in 15+  papers. \\
...
%
\textbf{4.} & & \textit{High-accuracy mass, spin, and recoil predictions of generic black-hole merger remnants.} 
\newline{}
V. Varma, \textbf{D. Gerosa}, F. H\'ebert, L. C. Stein, H. Zhang.
\newline{}
\href{https://arxiv.org/abs/1809.09125}{arXiv:1809.091259 [gr-qc]}.
\suppress \cite{2018arXiv180909125V} \endsuppress
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Frequency-domain waveform approximants capturing Doppler shifts.} 
\newline{}
...
%
\textbf{25.} & & \textit{Mining gravitational-wave catalogs to understand binary stellar evolution: a new hierarchical bayesian framework.} 
\newline{}
S. R. Taylor, \textbf{D.~Gerosa}.
\newline{}
\prd, in press.
\href{https://arxiv.org/abs/1806.08365}{arXiv:1806.08365 [astro-ph.HE]}.
\suppress \cite{2018arXiv180608365T} \endsuppress
\vspace{0.09cm}\\
\textbf{24.} & & \textit{Gravitational-wave astrophysics with effective-spin measurements: asymmetries and selection biases.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{23.} & & \textit{Spin orientations of merging black holes formed from the evolution of stellar binaries.} 
\newline{}
...
\suppress \cite{2018arXiv180802491G} \endsuppress
\vspace{0.09cm}\\
%
