...
\vspace{-0.1cm}
\begin{tabular}{rcl}
&\hspace{0.4cm} &$\circ\;\;${\textit{Support}}: Isaac Newton Studentship of the University of Cambridge and STFC Ph.D. Studentship.\\
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{15} papers published in peer-reviewed journals} \\
& &{(out of which \textbf{10} first-authored papers and \textbf{3} papers covered by press release)}
%\\
%& &{\textbf{1} submitted paper}
 \\
& &{\textbf{1} paper in conference proceedings}, {\textbf{2} papers in submission stage}
\end{tabular}
}
\textbf{Total number of citations:} 395 (using ADS and InSpire)
...
\hspace{0.71cm} \textit{Measurability of black-hole kicks with gravitational-wave observations} 
...
\cvitem{Open source projects}{\textsc{filltex}, automatic queries to fill LaTex bibliography (see \href{https://github.com/dgerosa/filltex}{github.com/dgerosa/filltex}) }
%\cvitem{Operating systems}{Mac OS, Linux, Windows.}
\cvitem{Programming languages}{Python (advanced), Mathematica, C, Fortran, %(also with Root, RooFit and Numerical Recipes tools),\newline 
Bash.}
\cvitem{Other scientific tools}{LIGO lalsuite, LaTex, GIT, SVN, Gnuplot, SuperMongo.}
