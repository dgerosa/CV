...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{18} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,} 
\\
...
\textbf{1.} & & \textit{Impact of Bayesian prior on the characterization of binary black hole coalescences.} 
\newline{}
...
\vspace{0.09cm}\\
\textbf{2.} & & \textit{GW170104 and the origin of heavy, low-spin binary black holes via classical isolated binary evolution.} 
\newline{}
