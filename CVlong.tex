...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{22} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
...
\textbf{Total number of citations:}  {>720}  (using ADS and InSpire).
...
\cvitemwithcomment{Referee}{Astrophysical Journal, Physical Review D, Monthly Notices of the Royal Astronomical Society,}{}\vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.8cm}General Relativity and Gravitation, European Physical Journal Plus.}{}% %Universe.\\}{}
...
\newline{}
\textcolor{color1}{$\bullet$} Open source code.
\suppress \cite{2017JOSS.2017..222G} \endsuppress
\vspace{0.09cm}\\
%
