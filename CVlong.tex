...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{26} talks at conferences}, {\textbf{25} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{35} invited presentations).}
\end{tabular}
}
