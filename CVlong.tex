...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{25} papers published in major peer-reviewed journals}, {\textbf{7} papers in submission stage,}
\\
& &{\textbf{4} other papers published in conference proceedings, software journals, etc,}
\\
& &{(out of which \textbf{18} first-authored papers and \textbf{3} papers covered by press releases).}
\end{tabular}
}
...
%
\textbf{7.} & & \textit{The binary black hole explorer: on-the-fly visualizations of precessing binary black holes.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Wide precession: binary black-hole spins repeatedly oscillating from full alignment to full anti-alignment.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{High-accuracy mass, spin, and recoil predictions of generic black-hole merger remnants.} 
\newline{}
