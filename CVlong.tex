...
\textbf{Total number of citations:} 418 (using ADS and InSpire).
...
%\end{tabular}
\textbf{Counts}: {\textbf{16} talks at conferences}, {\textbf{13} talks at department seminars}, {\textbf{7} posters at conferences.}
%\end{tabular}
}
