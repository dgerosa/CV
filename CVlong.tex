...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{29} talks at conferences}, {\textbf{26} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{38} invited presentations).}
\end{tabular}
}
...
$\circ\;$ NASA Graduate Fellowship Program (NESSF), USA; \\
...
$\circ\;$ American Physical Society (member) & $\circ\;$ Royal Astronomical Society (member)\\
\end{tabular}
%\vspace{+0.15cm}
...
%Proc. of the International Astronomical Union, IAU Symposium 338, in press.
 \newline{}  % REMOVE THIS
