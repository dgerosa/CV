...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{27} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{29} talks at conferences}, {\textbf{25} talks at department seminars}, {\textbf{7} posters at conferences,} \\
...
%
\textbf{5.} & & \textit{The binary black hole explorer: on-the-fly visualizations of precessing binary black holes.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Wide precession: binary black-hole spins repeatedly oscillating from full alignment to full anti-alignment.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Optimizing LIGO with LISA forewarnings to improve black-hole spectroscopy.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Black holes, gravitational waves and fundamental physics: a roadmap.} 
\newline{}
...
\suppress \cite{2018arXiv180904799C} \endsuppress
\vspace{0.09cm}\\
%
