...
%\textbf{Ulrich Sperhake} && Reader; University of Cambridge, Cambridge, UK.  \\
...
% \vspace{0.1cm} \\
%\textbf{Yanbei Chen} && Professor; California Institute of Technology, Pasadena CA, USA. \\
...
\\
& &{\textbf{2} other papers published/submitted in conference proceedings, software journals, etc,}
\\
& &{(out of which \textbf{14} first-authored papers and \textbf{3} papers covered by press releases).}
\end{tabular}
}
\textbf{Total number of citations:} 581 (using ADS and InSpire).
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{20} talks at conferences}, {\textbf{16} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{24} invited presentations).}
\end{tabular}
}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ K.~Chamberlain, Caltech and Montana State University.}{Summer 2017} \vspace{-0.1cm}
...
\textbf{\textcolor{black}{Grant proposal reviewer and panelist}} for NASA Astrophysics Theory Program (ATP), NASA Graduate Fellowship Program (NESSF).
...
%\newpage{}
\vspace{0.2cm}
\textbf{\textcolor{black}{Memberships}}: LISA Consortium; GWIC 3G Team (planning for a 3$^\textsf{rd}$ generation ground-based gravitational-wave network); American Physical Society; Royal Astronomical Society.
...
\textbf{20.} & & \textit{Impact of Bayesian prior on the characterization of binary black hole coalescences.} 
\newline{}
...
U. Sperhake, C. J. Moore, R. Rosca, M. Agathos,  \textbf{D.~Gerosa}, C. D. Ott.
 \newline{}
\href{https://journals.aps.org/prl/accepted/ea073Yd6Ue816852a9b101b3bc627c9d7464de8ef}{\prl, in press.}
\href{https://arxiv.org/abs/1708.03651}{arXiv:1708.03651 [gr-qc]}.
\suppress \cite{2017arXiv170803651S} \endsuppress
\vspace{0.09cm}\\
%
