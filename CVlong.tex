...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{21} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
...
\textbf{Total number of citations:} 658 (using ADS and InSpire).
...
\vspace{+0.2cm}
\cvitem{\textcolor{color1}{Selected publications, included in the application package}}{}
\vspace{-0.7cm}
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{22} talks at conferences}, {\textbf{18} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{28} invited presentations).}
\end{tabular}
}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$  Observer member, management committee of European COST grant CA16104 ``GWverse''.}{2017-now}\vspace{-0.1cm}
...
\\ &\hspace{0.4cm} &  \hspace{0.4cm}black-hole binary evolution YouTube channel, open source software \textsc{gwdet}.
\end{tabular}
...
%
\textbf{2.} & & \textit{Black-hole kicks from numerical-relativity surrogate models.} 
\newline{}
...
\suppress \cite{2017arXiv170901943W} \endsuppress
\vspace{0.09cm}\\
%
...
\suppress \cite{2017PhRvL.119y1103V} \endsuppress % UPDATE
\vspace{0.09cm}\\
%
...
\textbf{D.~Gerosa}
  \newline{} 
Open Access Journal of Physics: Conference Series, submitted. 
\href{https://arxiv.org/abs/1711.10038}{arXiv:1711.10038 [astro-ph.HE]}.
\suppress \cite{2017arXiv171110038G} \endsuppress
\vspace{0.09cm}\\
%
