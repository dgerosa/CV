...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{22} papers published in major peer-reviewed journals}, {\textbf{1} papers in submission stage,}
\\
...
\textbf{Total number of citations:} 710 (using ADS and InSpire).
...
%
\textbf{1.} & & \textit{GW170104 and the origin of heavy, low-spin binary black holes via classical isolated binary evolution.} 
\newline{}
