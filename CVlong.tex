...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{22} papers published in major peer-reviewed journals}, {\textbf{6} papers in submission stage,}
\\
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{26} talks at conferences}, {\textbf{23} talks at department seminars}, {\textbf{7} posters at conferences,} \\
...
%
\textbf{6.} & & \textit{Spin orientations of merging black holes formed from the evolution of stellar binaries.} 
\newline{}
\textbf{D.~Gerosa}, E. Berti, R. O'Shaughnessy, K. Belczynski, M. Kesden, D. Wysocki, W. Gladysz.
\newline{}
\href{https://arxiv.org/abs/XXXX.XXXXX}{arXiv:XXXX.XXXXX  [astro-ph.HE]}.
\suppress \cite{2018arXivXXXXXXXXXD} \endsuppress
\vspace{0.09cm}\\
%
