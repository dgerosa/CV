...
%
\textbf{8.} & & \textit{Orbital eccentricity in general relativity from catastrophe theory.}
\newline{}
M. Boschini, N. Loutrel, \textbf{D. Gerosa}, G. Fumagalli.
\newline{}
\href{https://arxiv.org/abs/2411.00098 [gr-qc]}{arXiv:2411.00098 [gr-qc].}
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Forecasting the population properties of merging black holes.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{A test for LISA foreground Gaussianity and stationarity. I. Galactic white-dwarf binaries.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Minimum gas mass accreted by spinning intermediate-mass black holes in stellar clusters.}
\newline{}
K. Kritos, L. Reali, \textbf{D. Gerosa}, E. Berti.
\newline{}
\href{https://arxiv.org/abs/2409.15439 [astro-ph.HE]}{arXiv:2409.15439 [astro-ph.HE].}
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Stars or gas? Constraining the hardening processes of massive black-hole binaries with LISA.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Which is which? Identification of the two compact objects in gravitational-wave binaries.}
\newline{}
...
\cvitem{}{\small\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
%
\textbf{87.} & & \textit{POSTMERGER: A flexible mapping of ringdown amplitudes for non-precessing binary black holes.}
\newline{}
