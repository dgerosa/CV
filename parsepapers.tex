...
\cvitem{}{\small\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
%
\textbf{117.} & & \textit{Gravitational-wave astronomy requires population-informed parameter estimation.}
\newline{}
M. Mould, R. Tenorio, \textbf{D. Gerosa}.
\newline{}
{\prd in press (2026)}. \href{https://arxiv.org/abs/2604.15885}{arXiv:2604.15885 [gr-qc].}
\vspace{0.09cm}\\
%
\textbf{116.} & & \textit{On the exceptionality of exceptional gravitational-wave events.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{114.} & & \textit{Cosmology with the angular cross-correlation of gravitational-wave and galaxy catalogs: forecasts for next-generation interferometers and the Euclid survey.}
\newline{}
