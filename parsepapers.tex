...
%
\textbf{7.} & & \textit{Ringdown mode amplitudes of precessing binary black holes.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Cosmology with the angular cross-correlation of gravitational-wave and galaxy catalogs: forecasts for next-generation interferometers and the Euclid survey.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{SFTs: a scalable data-analysis framework for long-duration gravitational-wave signals.}
\newline{}
