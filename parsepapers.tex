...
%
\textbf{3.} & & \textit{One to many: comparing single gravitational-wave events to astrophysical populations.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Parameter estimation of binary black holes in the endpoint of the up-down instability.}
\newline{}
