...
\cvitem{}{\small\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
%
\textbf{96.} & & \textit{Scalable data-analysis framework for long-duration gravitational waves from compact binaries using short Fourier transforms.}
\newline{}
R. Tenorio, \textbf{D. Gerosa}.
\newline{}
{\prd in press}. \href{https://arxiv.org/abs/2502.11823}{arXiv:2502.11823 [gr-qc].}
\vspace{0.09cm}\\
%
\textbf{95.} & & \textit{Reconstructing parametric gravitational-wave population fits from non-parametric results without refitting the data.}
\newline{}
