...
%
\textbf{11.} & & \textit{Impact of facility timing and coordination for next-generation gravitational-wave detectors.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{10.} & & \textit{Where did heavy binaries go? Gravitational-wave populations using Delaunay triangulation with optimized complexity.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{9.} & & \textit{Probing modified gravitational-wave dispersion with bursts from eccentric black-hole binaries.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{8.} & & \textit{Can stellar physics explain GW231123?}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Comparing astrophysical models to gravitational-wave data in the observable space.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Bayesian luminosity function estimation in multidepth datasets with selection effects: a case study for $3<z<5$ Ly$\alpha$ emitters.}
\newline{}
D. Tornotti, M. Fossati, M. Fumagalli, \textbf{D. Gerosa}, L. Pizzuti, F. Arrigoni Battaia.
\newline{}
\href{https://arxiv.org/abs/2506.10083}{arXiv:2506.10083 [astro-ph.GA].}
\vspace{0.09cm}\\
%
