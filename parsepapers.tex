...
%
\textbf{6.} & & \textit{Targeting black holes from metal-poor progenitors with next-generation gravitational-wave detectors.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Gravitational-wave astronomy requires population-informed parameter estimation.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Accurate and efficient simulation-based inference for massive black-hole binaries with LISA.}
\newline{}
