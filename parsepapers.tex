...
%
\textbf{8.} & & \textit{Sampling the full hierarchical population posterior distribution in gravitational-wave astronomy.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{SFTs: a scalable data-analysis framework for long-duration gravitational-wave signals.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Non-adiabatic dynamics of eccentric black-hole binaries in post-Newtonian theory.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{A confirmed recoiling supermassive black hole in a powerful quasar.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Reconstructing parametric gravitational-wave population fits from non-parametric results without refitting the data.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Which is which? Identification of the two compact objects in gravitational-wave binaries.}
\newline{}
