...
%
\textbf{4.} & & \textit{Characterization of merging black holes with two precessing spins.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Which black hole formed first? Mass-ratio reversal in massive binary stars from gravitational-wave data.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Deep learning and Bayesian inference of gravitational-wave populations: hierarchical black-hole mergers.}
\newline{}
...
\newline{}
{\cqg, in press}. \href{https://arxiv.org/abs/2202.08848}{arXiv:2202.08848 [gr-qc].}
\vspace{0.09cm}\\
%
