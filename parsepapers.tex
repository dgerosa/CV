...
%
\textbf{4.} & & \textit{Population-level correlations in Bayesian statistics: an illustrative model for gravitational-wave astronomy.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Targeting black holes from metal-poor progenitors with next-generation gravitational-wave detectors.}
\newline{}
F. Leto di Priolo, M. Chruślińska, \textbf{D. Gerosa}.
\newline{}
\href{https://arxiv.org/abs/2606.03776}{arXiv:2606.03776 [astro-ph.HE].}
\vspace{0.09cm}\\
%
