...
%
\textbf{10.} & & \textit{Variance of gravitational-wave populations.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{9.} & & \textit{Inferring the population properties of galactic binaries from LISA's stochastic foreground.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Comparing astrophysical models to gravitational-wave data in the observable space.}
\newline{}
