...
%
\textbf{8.} & & \textit{Accurate and efficient simulation-based inference for massive black-hole binaries with LISA.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Variance of gravitational-wave populations.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Inferring the population properties of galactic binaries from LISA's stochastic foreground.}
\newline{}
...
\cvitem{}{\small\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
%
\textbf{14.} & & \textit{Coincident morphological transitions in precessing black-hole binaries.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{13.} & & \textit{PRECESSION 2.1: black-hole binary spin precession on eccentric orbits.}
\newline{}
