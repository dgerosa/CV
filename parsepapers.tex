...
%
\textbf{10.} & & \textit{Comparing astrophysical models to gravitational-wave data in the observable space.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{9.} & & \textit{GW200208\_222617 as an eccentric black-hole binary merger: properties and astrophysical implications.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{8.} & & \textit{Accelerated inference of binary black-hole populations from the stochastic gravitational-wave background.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Bayesian luminosity function estimation in multidepth datasets with selection effects: a case study for $3<z<5$ Ly$\alpha$ emitters.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Sequential simulation-based inference for extreme mass ratio inspirals.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Distinguishing the origin of eccentric black-hole mergers with gravitational-wave spin measurements.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{A test for LISA foreground Gaussianity and stationarity. I. Galactic white-dwarf binaries.}
\newline{}
