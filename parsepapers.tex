...
%
\textbf{8.} & & \textit{Gravitational-wave astronomy requires population-informed parameter estimation.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Accurate and efficient simulation-based inference for massive black-hole binaries with LISA.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Variance of gravitational-wave populations.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{On the exceptionality of exceptional gravitational-wave events.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Black-hole ringdown with templates capturing spin precession: a criticalre-analysis of GW190521.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Inferring the population properties of galactic binaries from LISA's stochastic foreground.}
\newline{}
