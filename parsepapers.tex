...
\cvitem{}{\small\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
%
\textbf{105.} & & \textit{Distinguishing the origin of eccentric black-hole mergers with gravitational-wave spin measurements.}
\newline{}
J. Stegmann, \textbf{D. Gerosa}, I. Romero-Shaw, G. Fumagalli, H. Tagawa, L. Zwick.
\newline{}
{\apjl in press}. \href{https://arxiv.org/abs/2505.13589}{arXiv:2505.13589 [astro-ph.HE].}
\vspace{0.09cm}\\
%
...
\vspace{0.09cm}\\
%
\textbf{103.} & & \textit{Bayesian luminosity function estimation in multidepth datasets with selection effects: a case study for $3<z<5$ Ly$\alpha$ emitters.}
\newline{}
