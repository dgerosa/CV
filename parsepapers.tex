...
%
\textbf{5.} & & \textit{Which black hole formed first? Mass-ratio reversal in massive binary stars from gravitational-wave data.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{The last three years: multiband gravitational-wave observations of stellar-mass binary black holes.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Constraining black-hole binary spin precession and nutation with sequential prior conditioning.}
\newline{}
D. Gangardt, \textbf{D. Gerosa}, M. Kesden, V. De Renzis, N. Steinle.
\newline{}
\href{https://arxiv.org/abs/2204.00026}{arXiv:2204.00026 [gr-qc].}
\vspace{0.09cm}\\
%
