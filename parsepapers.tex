...
%
\textbf{10.} & & \textit{Ab uno disce omnes: Single-harmonic search for extreme mass-ratio inspirals.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{9.} & & \textit{Impact of facility timing and coordination for next-generation gravitational-wave detectors.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{8.} & & \textit{Probing modified gravitational-wave dispersion with bursts from eccentric black-hole binaries.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Can stellar physics explain GW231123?}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Comparing astrophysical models to gravitational-wave data in the observable space.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Sequential simulation-based inference for extreme mass ratio inspirals.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Distinguishing the origin of eccentric black-hole mergers with gravitational-wave spin measurements.}
\newline{}
J. Stegmann, \textbf{D. Gerosa}, I. Romero-Shaw, G. Fumagalli, H. Tagawa, L. Zwick.
\newline{}
\href{https://arxiv.org/abs/2505.13589}{arXiv:2505.13589 [astro-ph.HE].}
\vspace{0.09cm}\\
%
