...
%
\textbf{8.} & & \textit{Ringdown mode amplitudes of precessing binary black holes.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Cosmology with the angular cross-correlation of gravitational-wave and galaxy catalogs: forecasts for next-generation interferometers and the Euclid survey.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{SFTs: a scalable data-analysis framework for long-duration gravitational-wave signals.}
\newline{}
R. Tenorio, \textbf{D. Gerosa}.
\newline{}
\href{https://arxiv.org/abs/2502.11823}{arXiv:2502.11823 [gr-qc].}
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Non-adiabatic dynamics of eccentric black-hole binaries in post-Newtonian theory.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Reconstructing parametric gravitational-wave population fits from non-parametric results without refitting the data.}
\newline{}
C. M. Fabbri, \textbf{D. Gerosa}, A. Santini, M. Mould, A. Toubiana, J. Gair.
\newline{}
{\prd in press}. \href{https://arxiv.org/abs/2501.17233}{arXiv:2501.17233 [astro-ph.HE].}
\vspace{0.09cm}\\
%
\end{longtable} }
...
\newline{}
{\prd in press}. \href{https://arxiv.org/abs/2502.12156}{arXiv:2502.12156 [gr-qc].}
\vspace{0.09cm}\\
%
