...
%
\textbf{9.} & & \textit{Bayesian luminosity function estimation in multidepth datasets with selection effects: a case study for $3<z<5$ Ly$\alpha$ emitters.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{8.} & & \textit{Sequential simulation-based inference for extreme mass ratio inspirals.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{7.} & & \textit{Distinguishing the origin of eccentric black-hole mergers with gravitational-wave spin measurements.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{6.} & & \textit{Ringdown mode amplitudes of precessing binary black holes.}
\newline{}
