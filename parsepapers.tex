...
%
\textbf{3.} & & \textit{Parameter estimation of binary black holes in the endpoint of the up-down instability.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Efficient multi-timescale dynamics of precessing black-hole binaries.}
\newline{}
