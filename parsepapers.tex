...
\cvitem{}{\small\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.8cm}}
%
\textbf{100.} & & \textit{A test for LISA foreground Gaussianity and stationarity. I. Galactic white-dwarf binaries.}
\newline{}
R. Buscicchio, A. Klein, V. Korol, F. Di Renzo, C. J. Moore, \textbf{D. Gerosa}, A. Carzaniga.
\newline{}
{European Physical Journal C, in press (2025)}. \href{https://arxiv.org/abs/2410.08263}{arXiv:2410.08263 [astro-ph.HE].}
\vspace{0.09cm}\\
%
\textbf{99.} & & \textit{“LHS in LHS”: a new expansion strategy for Latin hypercube sampling in simulation design.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{98.} & & \textit{Ringdown mode amplitudes of precessing binary black holes.}
\newline{}
