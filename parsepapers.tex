...
%
\textbf{6.} & & \textit{Gravitational-wave astronomy requires population-informed parameter estimation.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Accurate and efficient simulation-based inference for massive black-hole binaries with LISA.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Variance of gravitational-wave populations.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{On the exceptionality of exceptional gravitational-wave events.}
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Cosmology with the angular cross-correlation of gravitational-wave and galaxy catalogs: forecasts for next-generation interferometers and the Euclid survey.}
\newline{}
