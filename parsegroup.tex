...
\textbf{MSc students}: & \textbf{29} & so far (of which &\textbf{10}& currently in my group). \\
\textbf{BSc students}: & \textbf{43} & so far (of which &\textbf{1}& currently in my group). \\
\end{tabular} }
\vspace{0.2cm}
...
\vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ \textit{G.~Fumagalli} (Milano-Bicocca).*}{2022-current}
\vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ \textit{V.~De~Renzis} (Milano-Bicocca).}{2021-2024}
\vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ \textit{D.~Gangardt} (Birmingham).}{2020-2024}
\vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ \textit{M.~Mould} (Birmingham).}{2019-2023}
\vspace{-0.1cm}
