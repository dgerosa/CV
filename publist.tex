...
%\vspace{0,5cm}
\begin{tabular}{rcl}
\textcolor{red}{\textbf{Publication counts:}}&\hspace{0.3cm} &{\textbf{12} papers in peer-reviewed journals} \\
...
\textcolor{red}{\textbf{Total number citations:}} \textbf{} 245 (using ADS and InSpire)
