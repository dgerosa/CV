...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{color1}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{15} papers published in major peer-reviewed journals} \\
& &{(out of which \textbf{10} first-authored papers and \textbf{2} papers covered by press release),}
%\\
%& &{\textbf{1} submitted paper}
 \\
& &{\textbf{2} other papers (conference proceedings, software, etc.)}, {\textbf{3} papers in submission stage.}
\end{tabular}
}
...
X. Zhao, M. Kesden, \textbf{D.~Gerosa}.
 \newline{}
Submitted to \prd. arXiv:1704.????? [gr-qc].
