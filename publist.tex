...
%\vspace{0,5cm}
\begin{tabular}{rcl}
\textcolor{red}{\textbf{Publication counts:}}&\hspace{0.3cm} &{\textbf{13} papers in peer-reviewed journals} \\
...
\textcolor{red}{\textbf{Total number citations:}} \textbf{} 251 (using ADS and InSpire)
...
\textbf{D.~Gerosa}, M.~Kesden.
  \newline{}
Physical Review D, in press. arXiv:1605.01067 [astro-ph.HE]. \textbf{Open source code.}
\vspace{0.05cm}\\
...
%\textcolor{red}{\textbf{Submitted papers:}}
%\vspace{-0.5cm}
%
%\cvitem{}{\small
%\hspace{-1cm}\begin{longtable}{rp{0.3cm}p{15.55cm}}
%\textbf{[1]} & & \textit{PRECESSION. Dynamics of spinning black-hole binaries with python.} 
%\newline{}
%\textbf{D.~Gerosa}, M.~Kesden.
%  \newline{}
%Submitted to Physical Review D. arXiv:1605.01067 [astro-ph.HE]. \textbf{Open source code.}
%\vspace{0.05cm}\\
%\end{longtable}
%}
