...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{color1}{\textbf{Counts:}} &\hspace{0.3cm} &{\textbf{15} papers published in peer-reviewed journals} {(out of which \textbf{10} first-authored)},
 \\
& &{\textbf{1} paper in conference proceedings}, {\textbf{3} papers in submission stage.}
\end{tabular}
}
\textcolor{color1}{\textbf{Total number of citations:}} 383 (using ADS and InSpire).
...
\textbf{D.~Gerosa}, M.~Vallisneri.
  \newline{}
Accepted in The Journal of Open Source Software. In press.
\vspace{0.05cm}\\
