...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{\textcolor{color1}{Counts:}} &\hspace{0.3cm} &{\textbf{20} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,} \\
...
\textcolor{color1}{\textbf{Total number of citations:}} \textbf{624} (using ADS and InSpire).

\textcolor{color1}{\textbf{h-index:}} \textbf{13}
