...
\textcolor{color1}{\textbf{Total number of citations:}} 342 (using ADS and InSpire)
...
\textbf{1.} & & \textit{First or second generation? Black hole census with gravitational wave observations.} 
\newline{}
