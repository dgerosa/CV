...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{color1}{\textbf{Counts:}} &\hspace{0.3cm} &{\textbf{14} papers published in peer-reviewed journals} {(out of which \textbf{9} first-authored)}
%\\
...
\textbf{D.~Gerosa}, U. Sperhake, J Vo\v{s}mera
  \newline{}
Submitted to \cqg. arXiv:1612.05263 [gr-qc].
\end{longtable}
}
