...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{\textcolor{color1}{Counts:}} &\hspace{0.3cm} &{\textbf{18} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,} \\
...
\textcolor{color1}{\textbf{Total number of citations:}} \textbf{467} (using ADS and InSpire).
