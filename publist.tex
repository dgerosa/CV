...
%& &{\textbf{1} submitted paper}
 \\
& &{\textbf{2} other papers (conference proceedings, software, etc.)}, {\textbf{2} papers in submission stage.}
\end{tabular}
}
\textcolor{color1}{\textbf{Total number of citations:}} 408 (using ADS and InSpire).
...
\suppress \cite{Gerosa2017} \endsuppress
\vspace{0.05cm}\\
