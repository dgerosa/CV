...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{\textcolor{color1}{Counts:}} &\hspace{0.3cm} &{\textbf{15} papers published in major peer-reviewed journals}, {\textbf{4} papers in submission stage,} \\
...
\textcolor{color1}{\textbf{Total number of citations:}} 445 (using ADS and InSpire).

\textcolor{color1}{\textbf{h-index:}} 11
...
\textbf{4.} & & \textit{GW170104 and the origin of heavy, low-spin binary black holes via classical isolated binary evolution.} 
\newline{}
