...
\textbf{62} papers published in major peer-reviewed journals,
...
\\ & &
(out of which \textbf{27} first-authored papers and
\textbf{7} papers covered by press releases).
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >3400.
\textcolor{mark_color}{\textbf{h-index}}: 31 (using ADS and InSpire).
\\
