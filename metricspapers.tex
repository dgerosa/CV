...
\textbf{70} papers published in major peer-reviewed journals,
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >4900.
\textcolor{mark_color}{\textbf{h-index}}: 36 (using ADS and InSpire).
\\
