...
\textbf{65} papers published in major peer-reviewed journals,
...
\end{tabular} }
\textcolor{mark_color}{\textbf{Total number of citations}}: >4400.
\textcolor{mark_color}{\textbf{h-index}}: 34 (using ADS and InSpire).
\\
