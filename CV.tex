...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ Caltech, Pasadena CA, USA. LIGO Summer Undergraduate Research Fellow.}{Jun-Aug 2012}
...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{14} papers published in peer-reviewed journals} {(out of which \textbf{9} first-authored)}
%\\
%& &{\textbf{1} submitted paper}
 \\
& &{\textbf{1} paper in conference proceedings}, {\textbf{1} paper in submission stage}
\end{tabular}
}
\textbf{Total number of citations:} 356 (using ADS and InSpire)
...
%\end{tabular}
\textbf{Counts}: {\textbf{13} talks at conferences}, {\textbf{12} talks at department seminars}, {\textbf{7} posters at conferences}
%\end{tabular}
}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ R.~Barbieri, University of Cambridge and University of Pavia.}{Summer 2016}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ \textit{Einstein's Legacy: Celebrating 100 yrs of General Relativity}, London Queen Mary UK (SOC).}{2015} \vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ \textit{The migration issue: from protoplanets to black holes}, KAVLI Institute, Cambridge UK (SOC).\hspace{-0.4cm}}{2017} \vspace{-0.1cm}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$  Student Representative, Gravitational Physics committee of the UK Institute of Physics.}{2014-2016}\vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$  Student Representative, Science Faculty Council, University of Milan, Italy}{2008-2012}\vspace{-0.1cm}
