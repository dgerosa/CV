...
$\quad$ Relativistic astrophysicist and gravitational-wave astronomer, studying the impact of Einstein's general relativity on the astrophysical world. Research interests include astrophysical inference with gravitational-wave sources, black-hole binary spin dynamics, black-hole recoils, accretion disks, tests of general relativity, and machine-learning tools.}}
...
\cvitemwithcomment{}{\textbf{NSF Grant PHY-1759835}, National Science Foundation, US}{2018}
...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{38} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>1500}  (using ADS and InSpire).

\textcolor{mark_color}{\textbf{h-index}}: 19
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{34} talks at conferences}, {\textbf{30} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{42} invited presentations).}
\end{tabular}
%mark_talknumbers
}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$  Observer member in management committee of European COST Action ``GWverse''.}{2017-2019}\vspace{-0.1cm}
...
\newline{}
Great fan of Bruce Springsteen. Some poor attempts at photography.%{}{}{I reached the top of Monte Rosa (4554 meters, Italy) and Piz Palù (3882 meters, Switzerland)}{}
...
%
\textbf{3.} & & \textit{Amplification of superkicks in black-hole binaries through orbital eccentricity.} 
\newline{}
U. Sperhake, R. Rosca-Mead, \textbf{D. Gerosa}, E. Berti.
\newline{}
\href{https://arxiv.org/abs/1910.01598}{arXiv:1910.01598 [gr-qc]}.
\suppress \cite{2019arXiv191001598S} \endsuppress
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Black holes in the low mass gap: Implications for gravitational wave observations.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{The evolutionary roads leading to low effective spins, high black hole masses, and O1/O2 rates of LIGO/Virgo binary black holes.
} 
\newline{}
K. Belczynski, J. Klencki, C. E. Fields, A. Olejak, E. Berti, G. Meynet, C. L. Fryer, D. E. Holz, R. O'Shaughnessy, D. A. Brown, T. Bulik, S. C. Leung,  K. Nomoto, P. Madau, R, Hirschi, S. Jones, S. Mondal, M. Chruslinska, P. Drozda, \textbf{D. Gerosa}, Z. Doctor, M. Giersz, S. Ekstr\:om, C. Georgy, A. Askar, D. Wysocki, T. Natan, W. M. Farr, G. Wiktorowicz, M. C. Miller, B. Farr, J.-P. Lasota.
 \newline{}
%Submitted to \cqg. 
...
%
\textbf{38.} & & \textit{Constraining the fraction of binary black holes formed in isolation and young star clusters with gravitational-wave data.} 
\newline{}
...
\suppress \cite{2019arXiv190511054B} \endsuppress
\vspace{0.09cm}\\
%
\textbf{37.} & & \textit{Machine-learning interpolation of population-synthesis simulations to interpret gravitational-wave observations: a case study.
} 
\newline{}
...
\suppress \cite{2019arXiv190906373W} \endsuppress
\vspace{0.09cm}\\
%
\textbf{36.} & & \textit{Surrogate models for precessing binary black hole simulations with unequal masses.} 
\newline{}
...
\suppress \cite{2019arXiv190509300V} \endsuppress
\vspace{0.09cm}\\
%
\textbf{35.} & & \textit{Gravitational-wave detection rates for compact binaries formed in isolation: LIGO/Virgo O3 and beyond.} 
\newline{}
...
\suppress \cite{2019arXiv190604197B} \endsuppress
\vspace{0.09cm}\\
%
\textbf{34.} & & \textit{Escape speed of stellar clusters from multiple-generation black-hole mergers in the upper mass gap.} 
\newline{}
