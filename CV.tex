...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{31} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>1100}  (using ADS and InSpire).
...
%
\textbf{5.} & & \textit{Are stellar-mass black-hole binaries too quiet for LISA?} 
\newline{}
C. J. Moore, \textbf{D.~Gerosa}, A. Klein.
\newline{}
\href{https://arxiv.org/abs/1905.11998}{arXiv:1905.11998 [gr-qc]}.
\suppress \cite{2019arXiv190511998M} \endsuppress
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Constraining the fraction of binary black holes formed in isolation and young star clusters with gravitational-wave data.} 
\newline{}
Y. Bouffanais, M. Mapelli, \textbf{D.~Gerosa}, U. N. Di Carlo, N. Giacobbo, E. Berti, V. Baibhav.
\newline{}
\href{https://arxiv.org/abs/1905.11054}{arXiv:1905.11054 [gr-qc]}.
\suppress \cite{2019arXiv190511054B} \endsuppress
\vspace{0.09cm}\\
%\
\textbf{3.} & & \textit{Surrogate models for precessing binary black hole simulations with unequal masses.} 
\newline{}
...
%
\textbf{30.} & & \textit{Black holes, gravitational waves and fundamental physics: a roadmap.} 
\newline{}
