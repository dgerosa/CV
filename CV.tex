...
\textbf{Total number of citations:} 529 (using ADS and InSpire).
...
%\end{tabular}
\textbf{Counts}: {\textbf{18} talks at conferences}, {\textbf{15} talks at department seminars}, {\textbf{7} posters at conferences.}
%\end{tabular}
}
