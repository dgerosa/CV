...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{52} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{39} talks at conferences}, {\textbf{35} talks at department seminars}, {\textbf{7} posters at conferences,} \\
