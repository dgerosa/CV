...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{57} papers published in major peer-reviewed journals}, {\textbf{2} paper in submission stage,}
\\
...
%
\textbf{2.} & & \textit{Bayesian parameter estimation of stellar-mass black-hole binaries with LISA.} 
\newline{}
