...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{45} talks at conferences}, {\textbf{36} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{53} invited presentations).}
\end{tabular}
%mark_talknumbers
}
