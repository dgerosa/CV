...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{50} papers published in major peer-reviewed journals}, {\textbf{4} papers in submission stage,}
\\
...
%
\textbf{4.} & & \textit{Eccentric binary black hole surrogate models for the gravitational waveform and remnant properties: comparable mass, nonspinning case.}  
\newline{}
