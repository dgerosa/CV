...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{51} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{38} talks at conferences}, {\textbf{35} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{50} invited presentations).}
\end{tabular}
%mark_talknumbers
}
...
%
\textbf{3.} & & \textit{Eccentric binary black hole surrogate models for the gravitational waveform and remnant properties: comparable mass, nonspinning case.}  
\newline{}
