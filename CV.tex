...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{38} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$  Observer (Caltech representative) in  committee of European COST Action ``GWverse''.}{2017-2019}\vspace{-0.1cm}
