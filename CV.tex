...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{53} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>2700}  (using ADS and InSpire).
...
\suppress \cite{2021arXiv210111798I} \endsuppress
\vspace{0.09cm}\\
%
