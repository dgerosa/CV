...
%mark_intro
\email{dgerosa@star.sr.bham.ac.uk $\;\;\bullet\;\;$ \today}
%mark_intro
...
\cvitemwithcomment{}{\textbf{Giulio Rampa Ph.D Thesis Prize}, Italian Society of General Relativity and Gravitational Physics.}{2018}
...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{38} papers published in major peer-reviewed journals}, {\textbf{6} papers in submission stage,}
\\
& &{\textbf{7} other publications (white papers, long-authorlists reviews, proceedings, software, etc)}
\\
& &{(out of which \textbf{20} first-authored papers and \textbf{5} papers covered by press releases).}
\end{tabular}
}
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>1700}  (using ADS and InSpire).
\textcolor{mark_color}{\textbf{h-index}}: 20
...
\\
%\vspace{0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ B.~Basset, University of Birmingham, Master's thesis.}{2020}
\vspace{-0.1cm}
...
\textbf{6.} & & \textit{The Bardeen-Petterson effect in accreting supermassive black-hole binaries: a systematic approach.} 
\newline{}
D. Gerosa, G. Rosotti, R. Barbieri.
\newline{}
\href{https://arxiv.org/abs/2004.02894}{arXiv:2004.02894 [astro-ph.GA]}.
\suppress \cite{2020arXiv2004.02894B} \endsuppress
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{The mass gap, the spin gap, and the origin of merging binary black holes.} 
\newline{}
V. Baibhav, D. Gerosa, E. Berti, K. W. K. Wong, T. Helfer, M. Mould.
\newline{}
\href{https://arxiv.org/abs/2004.00650}{arXiv:2004.00650 [gr-qc]}.
\suppress \cite{2020arXiv2004.00650B} \endsuppress
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Endpoint of the up-down instability in precessing binary black holes.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Milky Way satellites shining bright in gravitational waves.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Populations of double white dwarfs in Milky Way satellites and their detectability with LISA.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Black holes in the low mass gap: Implications for gravitational wave observations.} 
\newline{}
A. Gupta, \textbf{D. Gerosa}, K. G. Arun, E. Berti, B. S. Sathyaprakash.
\newline{}
...
%
\textbf{38.} & & \textit{The evolutionary roads leading to low effective spins, high black hole masses, and O1/O2 rates of LIGO/Virgo binary black holes.} 
\newline{}
