...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Publication counts}: &\hspace{0.3cm} &{\textbf{13} papers published in peer-reviewed journals} \\
& &{(out of which \textbf{8} first-authored)}
%\\
...
\textbf{Total number of citations:} 251 (using ADS and InSpire)
...
\cvitem{}{$\bullet$ Developer of open-source Python module \textsc{precession}: \href{https://github.com/dgerosa/precession}{github.com/dgerosa/precession}: complete toolbox to study the post-Newtonian dynamics of  spinning black-hole binaries (Gerosa \& Kesden 2015).}
