...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{54} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
& &{\textbf{8} other publications (white papers, long-authorlist reviews, proceedings, software, etc)}
\\
& &{(out of which \textbf{26} first-authored papers and \textbf{6} papers covered by press releases).}
\end{tabular}
}
...
\suppress \cite{2020arXiv210303894G} \endsuppress
\vspace{0.09cm}\\
%
...
\suppress \cite{2021arXiv201111948G} \endsuppress
\vspace{0.09cm}\\
%
