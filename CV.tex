...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{55} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
...
%
\textbf{3.} & & \textit{High mass but low spin: an exclusion region to rule out hierarchical
