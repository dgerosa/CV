...
\cvitemwithcomment{}{\textbf{HPC Midlands+ Substantial project}, 1.5M CPUh at UK Tier 2 cluster
.}{2020}
...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{43} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$  Italian Habilitation  to Associate Professorship in Theoretical Physics (ASN 02/A2).}{2018-2024}\vspace{-0.1cm}
...
%
\textbf{5.} & & \textit{Massive black hole binary inspiral and spin evolution in acosmological framework.} 
\newline{}
...
\suppress \cite{2020arXiv200402894G} \endsuppress
\vspace{0.09cm}\\
%
