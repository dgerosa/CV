...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{45} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
%
\textbf{5.} & & \textit{Structure of neutron stars in massive scalar-tensor gravity.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Gravitational-wave selection effects using neural-network classifiers.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Massive black hole binary inspiral and spin evolution in a cosmological framework.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Astrophysical implications of GW190412 as a remnant of a previous black-hole merger.} 
\newline{}
