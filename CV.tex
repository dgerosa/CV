...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{53} papers published in major peer-reviewed journals}, {\textbf{3} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>2800}  (using ADS and InSpire).
\textcolor{mark_color}{\textbf{h-index}}: 28
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{39} talks at conferences}, {\textbf{36} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{51} invited presentations).}
\end{tabular}
%mark_talknumbers
}
...
\cvitem{Other scientific tools}{TensorFlow, LIGO lalsuite, LaTex, git, slurm.}
...
%
\textbf{3.} & & \textit{Testing general relativity with gravitational-wave catalogs: the insidious nature of waveform systematics.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{A taxonomy of black-hole binary spin precession and nutation.} 
\newline{}
...
\textbf{39.} & & \textit{A self-consistent treatment of warped accretion disks surrounding spinning supermassive black holes.}
\newline{}Science at the Horizon: the Next-Generation EHT, (online), Feb 2021.
\vspace{0.05cm}\\
%
\textbf{38.} & * & \textit{Astrophysical black-hole binaries: the elephant in the room.}
...
\newline{}10th Birmingham Environment for Academic Research Conference, Birmingham, UK, (online), Sep 2020.
\vspace{0.05cm}\\
%
...
\newline{} 
Department seminars, Università degli Studi di Milano-Bicocca, Milan, Italy (online), Oct 2020.
\vspace{0.05cm}\\
%
