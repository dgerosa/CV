...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{27} talks at conferences}, {\textbf{25} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{36} invited presentations).}
\end{tabular}
}
