...
\cvitemwithcomment{}{\textbf{European Research Council (ERC): Starting Grant}, PI, 1.5M EUR, No.~945155}{2021-2026}
\cvitemwithcomment{}{\hspace{0.6cm}\textit{``Gravitational-wave data mining''}}{}

\cvitemwithcomment{}{\textbf{Leverhulme Trust: Research Project Grant}, PI, 190k GBP, No.~2019-350}{2020-2023}
...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{48} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
& &{\textbf{7} other publications (white papers, long-authorlist reviews, proceedings, software, etc)}
\\
& &{(out of which \textbf{23} first-authored papers and \textbf{6} papers covered by press releases).}
\end{tabular}
}
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>2200}  (using ADS and InSpire).
\textcolor{mark_color}{\textbf{h-index}}: 25
...
%
\textbf{2.} & & \textit{Gravitational-wave selection effects using neural-network classifiers.} 
\newline{}
