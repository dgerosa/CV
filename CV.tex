...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{41} papers published in major peer-reviewed journals}, {\textbf{4} papers in submission stage,}
\\
& &{\textbf{7} other publications (white papers, long-authorlist reviews, proceedings, software, etc)}
\\
& &{(out of which \textbf{21} first-authored papers and \textbf{5} papers covered by press releases).}
\end{tabular}
}
...
%
\textbf{\textcolor{black}{Supervised postdocs:}}
\vspace{0.1cm}
\\
