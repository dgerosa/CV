...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{41} papers published in major peer-reviewed journals}, {\textbf{6} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>1900}  (using ADS and InSpire).
\textcolor{mark_color}{\textbf{h-index}}: 23
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{34} talks at conferences}, {\textbf{33} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{45} invited presentations).}
\end{tabular}
%mark_talknumbers
}
...
%
\textbf{6.} & & \textit{Core collapse in massive scalar-tensor gravity.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Astrophysical implications of GW190412 as a remnant of a previous black-hole merger.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Mapping the asymptotic inspiral of precessing binary black holes to their merger remnants.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{The Bardeen-Petterson effect in accreting supermassive black-hole binaries: a systematic approach.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{The mass gap, the spin gap, and the origin of merging binary black holes.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Endpoint of the up-down instability in precessing binary black holes.} 
\newline{}
