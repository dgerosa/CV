...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>3000}  (using ADS and InSpire).
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{46} talks at conferences}, {\textbf{36} talks at department seminars}, {\textbf{7} posters at conferences,} \\
