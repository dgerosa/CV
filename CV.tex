...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{44} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
%
\textbf{4.} & & \textit{Massive black hole binary inspiral and spin evolution in a cosmological framework.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Core collapse in massive scalar-tensor gravity.} 
\newline{}
