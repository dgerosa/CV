...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{57} papers published in major peer-reviewed journals}, {\textbf{4} paper in submission stage,}
\\
& &{\textbf{8} other publications (white papers, long-authorlist reviews, proceedings, software, etc)}
\\
& &{(out of which \textbf{27} first-authored papers and \textbf{6} papers covered by press releases).}
\end{tabular}
}
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>3100}  (using ADS and InSpire).
\textcolor{mark_color}{\textbf{h-index}}: 29
...
%
\textbf{4.} & & \textit{Modeling the outcome of supernova explosions in binary population synthesis using the stellar compactness.} 
\newline{}
M. Dabrowny, N. Giacobbo, \textbf{D. Gerosa}.
\newline{}
\href{https://arxiv.org/abs/2106.12541}{arXiv:2106.12541 [astro-ph.HE]}.
\suppress \cite{2021arXiv210612541D} \endsuppress
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Bayesian parameter estimation of stellar-mass black-hole binaries with LISA.} 
\newline{}
...
\suppress \cite{2021arXiv210605259B} \endsuppress
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Looking for the parents of LIGO's black holes.} 
\newline{}
V. Baibhav, E. Berti, \textbf{D. Gerosa}, M. Mould, K. W. K. Wong.
\newline{}
\href{https://arxiv.org/abs/2105.12140}{arXiv:2105.12140 [gr-qc]}.
\suppress \cite{2021arXiv210512140B} \endsuppress
\vspace{0.09cm}\\
%
...
%
\textbf{56.} & & \textit{Hierarchical mergers of stellar-mass black holes and their gravitational-wave signatures.} 
\newline{}
...
\newline{}
\textcolor{color1}{$\bullet$} Review article.
\suppress \cite{2021arXiv210503439G} \endsuppress
\vspace{0.09cm}\\
%
\textbf{57.} & & \textit{High mass but low spin: an exclusion region to rule out hierarchical
...
\suppress \cite{2021arXiv210411247G} \endsuppress
\vspace{0.09cm}\\
%
...
\suppress \cite{2021arXiv210316486M} \endsuppress
\vspace{0.09cm}\\
%
...
\suppress \cite{2021arXiv210303894G} \endsuppress
\vspace{0.09cm}\\
%
