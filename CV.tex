...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{56} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>2900}  (using ADS and InSpire).
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{43} talks at conferences}, {\textbf{36} talks at department seminars}, {\textbf{7} posters at conferences,} \\
...
%
\textbf{2.} & & \textit{Testing general relativity with gravitational-wave catalogs: the insidious nature of waveform systematics.} 
\newline{}
