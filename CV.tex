...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{36} papers published in major peer-reviewed journals}, {\textbf{4} papers in submission stage,}
\\
...
%
\textbf{4.} & & \textit{Machine-learning interpolation of population-synthesis simulations to interpret gravitational-wave observations: a case study.
} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Black holes in the low mass gap: Implications for gravitational wave observations.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Constraining the fraction of binary black holes formed in isolation and young star clusters with gravitational-wave data.} 
\newline{}
