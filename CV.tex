...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{31} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
& &{\textbf{4} other papers published in conference proceedings, software journals, etc,}
\\
& &{(out of which \textbf{19} first-authored papers and \textbf{4} papers covered by press releases).}
\end{tabular}
}
