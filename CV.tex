...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{42} talks at conferences}, {\textbf{36} talks at department seminars}, {\textbf{7} posters at conferences,} \\
...
\cvitem{}{\small
\hspace{-1cm}\begin{longtable}{rp{0.4cm}p{15.8cm}}
\textbf{9.} & *& \textit{Esplorare l'Universo con le onde gravitazionali.}
\newline{} 
