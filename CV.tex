...
\cvitem{}{
\begin{tabular}{rcl}
\textbf{Counts}: &\hspace{0.3cm} &{\textbf{15} papers published in peer-reviewed journals} {(out of which \textbf{19} first-authored)}
%\\
...
\textbf{Total number of citations:} 361 (using ADS and InSpire)
...
%\end{tabular}
\textbf{Counts}: {\textbf{15} talks at conferences}, {\textbf{12} talks at department seminars}, {\textbf{7} posters at conferences}
%\end{tabular}
}
