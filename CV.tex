...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{53} papers published in major peer-reviewed journals}, {\textbf{4} papers in submission stage,}
\\
...
%
\textbf{4.} & & \textit{High mass but low spin: an exclusion region to rule out hierarchical
