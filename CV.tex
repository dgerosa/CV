...
\hspace{0.4cm}
classes, mentoring students. UK Lecturer rank is roughly equivalent to Assistant Professor in the US.\\
\end{tabular}
\vspace{0.2cm}
...
&\hspace{0.4cm} &$\circ\;\;${\textit{Thesis advisors}}: E. Berti, G. Lodato. Resulted in 2 publications.\\
...
\vspace{0.2cm}
\textbf{\textcolor{black}{Interships:}}\vspace{0.05cm}\\
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Presentations}}: &\hspace{0.3cm} &{\textbf{32} talks at conferences}, {\textbf{28} talks at department seminars}, {\textbf{7} posters at conferences,} \\
& &{(out of which \textbf{40} invited presentations).}
\end{tabular}
%mark_talknumbers
}
...
\newline{}
Great fan of Bruce Springsteen. Attempts at photography.%{}{}{I reached the top of Monte Rosa (4554 meters, Italy) and Piz Palù (3882 meters, Switzerland)}{}
...
\newline{}
\apj, in press.
\href{https://arxiv.org/abs/1905.11054}{arXiv:1905.11054 [astro-ph.HE]}.
