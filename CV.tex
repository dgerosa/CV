...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{58} papers published in major peer-reviewed journals}, {\textbf{3} paper in submission stage,}
\\
...
%
\textbf{3.} & & \textit{Modeling the outcome of supernova explosions in binary population synthesis using the stellar compactness.} 
\newline{}
