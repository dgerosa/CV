...
\textbf{Total number of citations:} 342 (using ADS and InSpire)
...
%\end{tabular}
\textbf{Counts}: {\textbf{11} talks at conferences}, {\textbf{12} talks at department seminars}, {\textbf{7} posters at conferences}
%\end{tabular}
}
