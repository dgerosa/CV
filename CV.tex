...
\textbf{Total number of citations:} 329 (using ADS and InSpire)
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ Advanced General Relativity (Part III, master class).}{2015-2016} \vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ Introduction to General Relativity (Part II, 3rd-year undergraduate class).}{2014-2016}
...
\cvitem{}{\textbf{Developer}: open-source Python module \textsc{precession} (see \href{https://github.com/dgerosa/precession}{github.com/dgerosa/precession}); toolbox to study the post-Newtonian dynamics of  spinning black-hole binaries.}
%\cvitem{Operating systems}{Mac OS, Linux, Windows.}
\cvitem{Coding}{Python (advanced), Mathematica, C, Fortran, %(also with Root, RooFit and Numerical Recipes tools),\newline 
Bash.}
\cvitem{Other scientific tools}{LIGO lalsuite, LaTex, GIT, SVN, Gnuplot, SuperMongo.}
...
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ Einstein's Legacy, London Queen Mary UK (SOC).}{2015} \vspace{-0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ The migration issue, Cambridge UK (SOC).}{2017} \vspace{-0.1cm}
