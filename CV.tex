...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{39} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
\textbf{5.} & & \textit{The Bardeen-Petterson effect in accreting supermassive black-hole binaries: a systematic approach.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{The mass gap, the spin gap, and the origin of merging binary black holes.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Endpoint of the up-down instability in precessing binary black holes.} 
\newline{}
