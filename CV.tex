...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Publications}}: &\hspace{0.3cm} &{\textbf{49} papers published in major peer-reviewed journals}, {\textbf{2} papers in submission stage,}
\\
& &{\textbf{8} other publications (white papers, long-authorlist reviews, proceedings, software, etc)}
\\
& &{(out of which \textbf{24} first-authored papers and \textbf{6} papers covered by press releases).}
\end{tabular}
}
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>2500}  (using ADS and InSpire).
\textcolor{mark_color}{\textbf{h-index}}: 26
...
%
\textbf{3.} & & \textit{A generalized precession parameter $\chi_\mathrm{p}$ to interpret gravitational-wave data.}  
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{2.} & & \textit{Inferring the properties of a population of compact binaries in presence of selection effects.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{1.} & & \textit{Massive black hole binary inspiral and spin evolution in a cosmological framework.} 
\newline{}
