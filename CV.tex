...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{35} papers published in major peer-reviewed journals}, {\textbf{5} papers in submission stage,}
\\
...
\textcolor{mark_color}{\textbf{Total number of citations}}:  {>1300}  (using ADS and InSpire).
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{31} talks at conferences}, {\textbf{27} talks at department seminars}, {\textbf{7} posters at conferences,} \\
...
\vspace{0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ L.~Reali, University of Birmingham (visiting from University of Milan).}{2019}\vspace{-0.1cm}
%\hspace{0.71cm} \textit{Visualizing 2PN black-hole binary spin precession.}\\
\vspace{-0.0cm}
...
\vspace{0.1cm}
\cvitemwithcomment{}{\hspace{0.4cm}$\circ\;$ D.~Gangardt, University of Birmingham.}{2019}\vspace{-0.1cm}
%\hspace{0.71cm} \textit{Visualizing 2PN black-hole binary spin precession.}\\
\vspace{-0.0cm}
\hspace{0.8cm}Summer project. Main supervisor.
\vspace{-0.0cm}
...
%
\textbf{5.} & & \textit{Machine-learning interpolation of population-synthesis simulations to interpret gravitational-wave observations: a case study.
} 
\newline{}
K. W. K. Wong, \textbf{D. Gerosa}.
\newline{}
\href{https://arxiv.org/abs/1909.05804}{arXiv:1909.06373 [astro-ph.HE]}.
\suppress \cite{2019arXiv190906373W} \endsuppress
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Black holes in the low mass gap: Implications for gravitational wave observations.} 
\newline{}
...
\vspace{0.09cm}\\
%
\textbf{3.} & & \textit{Constraining the fraction of binary black holes formed in isolation and young star clusters with gravitational-wave data.} 
\newline{}
...
\vspace{0.09cm}\\
%\
\textbf{2.} & & \textit{Surrogate models for precessing binary black hole simulations with unequal masses.} 
\newline{}
