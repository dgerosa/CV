...
\cvitem{}{
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{32} papers published in major peer-reviewed journals}, {\textbf{6} papers in submission stage,}
\\
& &{\textbf{4} other papers published in conference proceedings, software journals, etc,}
\\
& &{(out of which \textbf{20} first-authored papers and \textbf{4} papers covered by press releases).}
\end{tabular}
}
...
%mark_talknumbers
\begin{tabular}{rcl}
\textcolor{mark_color}{\textbf{Counts}}: &\hspace{0.3cm} &{\textbf{29} talks at conferences}, {\textbf{27} talks at department seminars}, {\textbf{7} posters at conferences,} \\
...
%
\textbf{6.} & & \textit{Escape speed of stellar clusters from multiple-generation black-hole mergers in the upper mass gap.} 
\newline{}
\textbf{D.~Gerosa}, E. Berti.
\newline{}
\href{https://arxiv.org/abs/1906.05295}{arXiv:1906.05295 [astro-ph.HE]}.
\suppress \cite{2019arXiv1906.05295G} \endsuppress
\vspace{0.09cm}\\
%
\textbf{5.} & & \textit{Gravitational-wave detection rates for compact binaries formed in isolation: LIGO/Virgo O3 and beyond.} 
\newline{}
...
\suppress \cite{2019arXiv1906.04197B} \endsuppress
\vspace{0.09cm}\\
%
\textbf{4.} & & \textit{Are stellar-mass black-hole binaries too quiet for LISA?} 
\newline{}
C. J. Moore, \textbf{D.~Gerosa}, A. Klein.
\newline{}
\href{https://arxiv.org/abs/1905.11998}{arXiv:1905.11998 [astro-ph.HE]}.
\suppress \cite{2019arXiv190511998M} \endsuppress
\vspace{0.09cm}\\
%
